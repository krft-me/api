package me.krft.api.config.timezone;
...
import me.krft.api.repository.timezone.DateTimeWrapper;
import me.krft.api.repository.timezone.DateTimeWrapperRepository;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM krftme_date_time_wrapper where id=%d", fieldName, id);
    }
